...
namespace EnhancedDevelopment.Excalibur.LaserDrill
{
    ...
    class Building_LaserDrill : Building
    {
        ...
        public override void TickRare()
        {
            ...
            if (this.DrillWork <= 0)
            {
                ...
                if (this.DrillIterationNumber >= Mod_EDExcalibur.Settings.LaserDrill.DrillCharges)
                {
                    //Destroy
        ...
        {
            if (Mod_EDExcalibur.Settings.LaserDrill.AllowSimultaneousDrilling)
            {
                return;
            }
        ...
        public override string GetInspectString()
        {
            ...
            if (Mod_EDExcalibur.Settings.LaserDrill.DrillCharges > 1)
            {
                _StringBuilder.AppendLine("");
                _StringBuilder.Append("Charges: " + this.DrillIterationNumber + " / " + Mod_EDExcalibur.Settings.LaserDrill.DrillCharges);
            }
        ...
        private void CalculateWorkStart()
        {
            ...
            this.DrillWork = Mod_EDExcalibur.Settings.LaserDrill.RequiredDrillWork * (int)Math.Pow(2, this.DrillIterationNumber - 1);
        }
